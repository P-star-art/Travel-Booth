...
const UpdatePlace = () => {
    ...
    const identifier = DUMMY_PLACES.find(p => p.id === placeId);

    if (!identifier) {
        return (
            <div className="center"><h1>Could Not find place!</h1></div>
        )
    }
    ...
    return (
        <form>
            ...
            <Input
                ...
                errorText="Please enter a valid description (min. 5 words)."
                onInput={() => { }}
